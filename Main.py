...
class MainApp:
    def __init__(self, root):
        ...
        try:
            ...
            pass # Gracefully skip if favicon isn't in the directory
            
        self.root.geometry("500x700")  # Expanded size to cleanly fit the Treeview
    ...
    def create_widgets(self):
        ...
        # Treeview Configuration (From test.py with Scrollbar compatibility added)
    ...
    def update_treeview(self):
        ...
        # Sort hires alphabetically by customer name (from Main.py)
        sorted_hires = sorted(self.hired_data, key=lambda hire: hire["name"].lower())

        # Populate rows cleanly into columns
    ...
    def on_tree_select(self, event):
        ...
        if item_data:
            # Auto-fills the first index (Receipt Number) into the return field
